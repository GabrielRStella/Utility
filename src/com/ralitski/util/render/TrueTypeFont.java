...
public class TrueTypeFont {
	...
	public int drawString(float x, float y, String whatchars, float scaleX,
			float scaleY) {
		return drawString(x, y, whatchars, 0, whatchars.length() - 1, scaleX, scaleY,
				ALIGN_LEFT);
	}
	...
	public int drawString(float x, float y, String whatchars, int startIndex,
