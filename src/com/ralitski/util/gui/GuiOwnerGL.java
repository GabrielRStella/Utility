...
public abstract class GuiOwnerGL extends GuiOwnerAbstract {
    ...
    public GuiOwnerGL(int size) {
    	super(size);
    }

    public GuiOwnerGL(int width, int height) {
    	super(width, height);
    }

    public GuiOwnerGL(boolean is3D) {
    	super(is3D);
    }

    public GuiOwnerGL(int size, boolean is3D) {
    	super(size, is3D);
    }

    public GuiOwnerGL(int width, int height, boolean is3D) {
